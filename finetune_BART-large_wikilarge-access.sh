...
TASK=ts-wikilarge-access
HASH=_bfbd90ba0d8063b8ab58f91e854df426
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python ./access_train.py "./datasets/${HASH}/fairseq_preprocessed/" \
    ...
    --tensorboard-logdir "./logs/tensorboard/wikilarge-access/bart-large-pretrained/" \
    --save-dir "./checkpoints/wikilarge-access/bart-large-pretrained/" \
