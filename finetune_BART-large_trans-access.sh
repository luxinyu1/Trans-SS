HASH=_8d58eba9d029815d33f55ed9e61da9ba

TASK=ts-trans-access
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python ./access_train.py "./datasets/${HASH}/fairseq_preprocessed/" \
    ...
    --tensorboard-logdir "./logs/tensorboard/trans-access/bart-large-pretrained/" \
    --save-dir "./checkpoints/trans-access/bart-large-pretrained/" \
